...
I am Marcus, programming is my passion, I am self-taught and the creative and problem-solving mindset that is required by coding is why I love programming. Every problem has a solution and I hope I am always as excited as I am today to solve them. " />
        ...
        <Card className="education" title="Education"
            details="2020 - 2021 Certificate IV in Programming, UpSkilledI have completed certificate four in programming. In this course, I learn agile development processes, application documentation, .Net, C#, SQL, and Xamarin. "
