...
export default function AllCards() {
    return (<>
        <Card className="aboutMe" photoAddress="./ProfilePic.jpg" title=" About Me" details="
I am Marcus, programming is my passion, I am self-taught and the creative and problem-solving mindset that is required by coding is why I love programming. Every problem has a solution and I hope I am always as excited as I am today to solve them. " />
        ...
        <Card className="passion" title="Passion" details="Programming is my passion. For a long time, I had no idea what I wanted to do but finally, I have found something I thoroughly enjoy doing day in and day out. When I am programming time flies by, I lose days and have to pull myself away from the computer to go do other things." />
        <Card className="education" title="Education"
            details="2020 - 2021 Certificate IV in Programming, UpSkilled I have completed certificate four in programming. In this course, I learn agile development processes, application documentation, .Net, C#, SQL, and Xamarin. "
            details2="2018 - Current Self-Taught I have been on a rigorous self-education journey ever since I began to mess with programming back in 2018. I love programming and will always love learning new languages as well as building on what I already know." />
        <Card className="experience" title="Experience" details="2018 - Current Unity, C# Developer In 2019 my first app launched on the Google Play Store. I have also been working on smaller side projects which include smaller games and react-based websites as well as my passion project. My passion project is a city-building strategy game that has an in-game intelligence system, which is intended to allow for a greater level of realism. Making games is a huge challenge but I welcome it. I am also currently working on an ambitious 3d VR game with a couple of good friends." />
        <Card className="summary" title="Summary" details=" I am always learning, and constantly developing my skills, I love programming, developing systems, and creating applications. I am always working on another project in my spare time to both expand my knowledge base and for my own enjoyment." />
    </>)
}